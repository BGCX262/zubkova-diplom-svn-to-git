...
namespace DogsClub.WebUI.Helpers
{
    public static class HomeNavigation
    {
        ...
        public static MvcHtmlString HomeNavigationLink(this HtmlHelper html, string linkText, string actionName, string controllerName)
        {
            ...
            {
                currentLinkClass = "homenavigation";
            }
